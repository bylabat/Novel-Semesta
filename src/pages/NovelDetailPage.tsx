...
export default function NovelDetailPage() {
  ...
  async function submitReport() {
    ...
    try {
      // =======================================================
      // CEK APAKAH USER SUDAH PERNAH MELAPORKAN NOVEL INI
      // =======================================================
      ...
      if (existingReportError) {
        console.error(
          "Gagal mengecek laporan sebelumnya:",
          existingReportError,
        );

        setReportError(
          "Gagal memeriksa laporan sebelumnya. Silakan coba lagi.",
        );
      ...
      console.error(
        "Kesalahan saat mengirim laporan:",
        err,
      );
